...
USE ROLE SYSADMIN;
--CREATE DATABASE AIR_OAI;
USE DATABASE AIR_OAI;
--create schema air_oai_facts;

--use schema air_oai.air_oai_facts;




/* Approach taken is to load the final file provided by Geof instead of shape files */
...
set	time_zone_name = c.time_zone_name, updated_by = current_user, updated_tsmt = current_timestamp
from (
...
from (select airport_history_id, airport_oai_code, effective_from_date, point_geom 
      from air_oai_dims.airport_history where time_zone_name is null /*limit 10000*/
...
truncate table air_oai_dims.airport_history;
copy into air_oai_dims.airport_history  FROM @csv_stage/T_MASTER_CORD_w_timezone.csv  ON_ERROR=CONTINUE FORCE = TRUE ;
...
drop  table if exists air_oai_facts.airline_flight_performance_fdw;
...
server mochida options 
    ...
    */
      ...
      ----DATA LOADING---------------
copy into AIR_OAI_FACTS.airline_flight_performance_fdw  
FROM @csv_stage
PATTERN='.*On_Time_Performance.*[.]csv.gz'
ON_ERROR=CONTINUE 
FORCE = TRUE ;



update air_oai_facts.airline_flight_performance_fdw  set report_depart_time_lcl ='0000' where report_depart_time_lcl ='2400';
update air_oai_facts.airline_flight_performance_fdw  set actual_depart_time_lcl ='0000' where actual_depart_time_lcl ='2400';
update air_oai_facts.airline_flight_performance_fdw  set wheels_off_time_lcl ='0000' where wheels_off_time_lcl ='2400';
update air_oai_facts.airline_flight_performance_fdw  set wheels_on_time_lcl='0000' where wheels_on_time_lcl='2400';
update air_oai_facts.airline_flight_performance_fdw  set report_arrive_time_lcl='0000' where report_arrive_time_lcl='2400';
update air_oai_facts.airline_flight_performance_fdw  set actual_arrive_time_lcl='0000' where actual_arrive_time_lcl='2400';
update air_oai_facts.airline_flight_performance_fdw  set first_gate_depart_time ='0000' where first_gate_depart_time ='2400';
update air_oai_facts.airline_flight_performance_fdw  set diverted1_wheels_on_time_lcl='0000' where diverted1_wheels_on_time_lcl='2400';
update air_oai_facts.airline_flight_performance_fdw  set diverted1_wheels_off_time_lcl='0000' where diverted1_wheels_off_time_lcl='2400';
update air_oai_facts.airline_flight_performance_fdw  set diverted2_wheels_on_time_lcl='0000' where diverted2_wheels_on_time_lcl='2400';
update air_oai_facts.airline_flight_performance_fdw  set diverted2_wheels_off_time_lcl='0000' where diverted2_wheels_off_time_lcl='2400';
update air_oai_facts.airline_flight_performance_fdw  set diverted3_wheels_on_time_lcl='0000' where diverted3_wheels_on_time_lcl='2400';
update air_oai_facts.airline_flight_performance_fdw  set diverted3_wheels_off_time_lcl='0000' where diverted3_wheels_off_time_lcl='2400';
update air_oai_facts.airline_flight_performance_fdw  set diverted4_wheels_on_time_lcl='0000' where diverted4_wheels_on_time_lcl='2400';
update air_oai_facts.airline_flight_performance_fdw  set diverted4_wheels_off_time_lcl='0000' where diverted4_wheels_off_time_lcl='2400';
...
drop table if exists air_oai_facts.airline_flight_performance_mv;
 create  table air_oai_facts.airline_flight_performance_mv as 
select flight_date
	 , airline_oai_code
	 , tail_nbr
	 , flight_nbr
...
-- PROBLEMS WITH TIMEZONE FROM HERE ---------------------

drop  table if exists air_oai_facts.airline_flight_performance_integrated_mv;
create  table air_oai_facts.airline_flight_performance_integrated_mv as
select md5(fp.airline_oai_code||'|'||fp.flight_nbr||'|'||fp.flight_date::text||'|'||fp.depart_airport_oai_code)::char(32) as flight_key
	 ...
	 , CONVERT_TIMEZONE(a.time_zone_name , a.time_zone_name,(flight_date::char(10)||' '||TO_TIME(report_depart_time_lcl ,'HH24MI' )) )::timestamp as report_depart_tmstz_lcl
	 ,CONVERT_TIMEZONE(a.time_zone_name,'UTC' ,(flight_date::char(10)||' '||TO_TIME(report_depart_time_lcl ,'HH24MI' )) ) as report_depart_tmstz_utc
	 , fp.report_arrive_time_lcl
    , CONVERT_TIMEZONE(b.time_zone_name , b.time_zone_name,(flight_date::char(10)||' '||TO_TIME(report_arrive_time_lcl ,'HH24MI' )) ) as report_arrive_tmstz_lcl
	 ,CONVERT_TIMEZONE(b.time_zone_name,'UTC' ,(flight_date::char(10)||' '||TO_TIME(report_arrive_time_lcl ,'HH24MI' )) ) as report_arrive_tmstz_utc
	 , fp.report_elapsed_time_min -- redundant?
	 , fp.actual_depart_time_lcl
    , CONVERT_TIMEZONE(a.time_zone_name , a.time_zone_name,(flight_date::char(10)||' '||TO_TIME(actual_depart_time_lcl ,'HH24MI' )) ) as actual_depart_tmstz_lcl
	 ,CONVERT_TIMEZONE(a.time_zone_name,'UTC' ,(flight_date::char(10)||' '||TO_TIME(actual_depart_time_lcl ,'HH24MI' )) ) as actual_depart_tmstz_utc
	 , fp.actual_arrive_time_lcl  
    , CONVERT_TIMEZONE(b.time_zone_name , b.time_zone_name,(flight_date::char(10)||' '||TO_TIME(actual_arrive_time_lcl ,'HH24MI' )) ) as actual_arrive_tmstz_lcl
	 ,CONVERT_TIMEZONE(b.time_zone_name,'UTC' ,(flight_date::char(10)||' '||TO_TIME(actual_arrive_time_lcl ,'HH24MI' )) ) as actual_arrive_tmstz_utc
     , fp.actual_elapsed_time_min -- redundant?
	 , fp.wheels_off_time_lcl
    , CONVERT_TIMEZONE(a.time_zone_name , a.time_zone_name,(flight_date::char(10)||' '||TO_TIME(wheels_off_time_lcl ,'HH24MI' )) ) as wheels_off_tmstz_lcl
	 ,CONVERT_TIMEZONE(a.time_zone_name,'UTC' ,(flight_date::char(10)||' '||TO_TIME(wheels_off_time_lcl ,'HH24MI' )) ) as wheels_off_tmstz_utc
    , fp.wheels_on_time_lcl
    , CONVERT_TIMEZONE(b.time_zone_name , b.time_zone_name,(flight_date::char(10)||' '||TO_TIME(wheels_on_time_lcl ,'HH24MI' )) ) as wheels_on_tmstz_lcl
	 ,CONVERT_TIMEZONE(b.time_zone_name,'UTC' ,(flight_date::char(10)||' '||TO_TIME(wheels_on_time_lcl ,'HH24MI' )) ) as wheels_on_tmstz_utc	
     ...
     ,CONVERT_TIMEZONE(a.time_zone_name , a.time_zone_name,(flight_date::char(10)||' '||TO_TIME(first_gate_depart_time ,'HH24MI' )) ) as first_gate_depart_tmstz_lcl
	 ,CONVERT_TIMEZONE(a.time_zone_name,'UTC' ,(flight_date::char(10)||' '||TO_TIME(first_gate_depart_time ,'HH24MI' )) ) as first_gate_depart_tmstz_utc	
    ...
    , CONVERT_TIMEZONE(d1.time_zone_name , d1.time_zone_name,(flight_date::char(10)||' '||TO_TIME(diverted1_wheels_on_time_lcl ,'HH24MI' )) ) as diverted1_wheels_on_tmstz_lcl
	 ,CONVERT_TIMEZONE(d1.time_zone_name,'UTC' ,(flight_date::char(10)||' '||TO_TIME(diverted1_wheels_on_time_lcl ,'HH24MI' )) ) as diverted1_wheels_on_tmstz_utc	
    , fp.diverted1_wheels_off_time_lcl 
     , CONVERT_TIMEZONE(d1.time_zone_name , d1.time_zone_name,(flight_date::char(10)||' '||TO_TIME(diverted1_wheels_off_time_lcl ,'HH24MI' )) ) as diverted1_wheels_off_tmstz_lcl
	 ,CONVERT_TIMEZONE(d1.time_zone_name,'UTC' ,(flight_date::char(10)||' '||TO_TIME(diverted1_wheels_off_time_lcl ,'HH24MI' )) ) as diverted1_wheels_off_tmstz_utc	
     ...
     , CONVERT_TIMEZONE(d2.time_zone_name , d2.time_zone_name,(flight_date::char(10)||' '||TO_TIME(diverted2_wheels_on_time_lcl ,'HH24MI' )) ) as diverted2_wheels_on_tmstz_lcl
	 ,CONVERT_TIMEZONE(d2.time_zone_name,'UTC' ,(flight_date::char(10)||' '||TO_TIME(diverted2_wheels_on_time_lcl ,'HH24MI' )) ) as diverted2_wheels_on_tmstz_utc
     , fp.diverted2_wheels_off_time_lcl
     , CONVERT_TIMEZONE(d2.time_zone_name , d2.time_zone_name,(flight_date::char(10)||' '||TO_TIME(diverted2_wheels_off_time_lcl ,'HH24MI' )) ) as diverted2_wheels_off_tmstz_lcl
	 ,CONVERT_TIMEZONE(d2.time_zone_name,'UTC' ,(flight_date::char(10)||' '||TO_TIME(diverted2_wheels_off_time_lcl ,'HH24MI' )) ) as diverted2_wheels_off_tmstz_utc
    ...
    , CONVERT_TIMEZONE(d3.time_zone_name , d3.time_zone_name,(flight_date::char(10)||' '||TO_TIME(diverted3_wheels_on_time_lcl ,'HH24MI' )) ) as diverted3_wheels_on_tmstz_lcl
	 ,CONVERT_TIMEZONE(d3.time_zone_name,'UTC' ,(flight_date::char(10)||' '||TO_TIME(diverted3_wheels_on_time_lcl ,'HH24MI' )) ) as diverted3_wheels_on_tmstz_utc
    
    , fp.diverted3_wheels_off_time_lcl
    , CONVERT_TIMEZONE(d3.time_zone_name , d3.time_zone_name,(flight_date::char(10)||' '||TO_TIME(diverted3_wheels_off_time_lcl ,'HH24MI' )) ) as diverted3_wheels_off_tmstz_lcl
	 ,CONVERT_TIMEZONE(d3.time_zone_name,'UTC' ,(flight_date::char(10)||' '||TO_TIME(diverted3_wheels_off_time_lcl ,'HH24MI' )) ) as diverted3_wheels_off_tmstz_utc
	 ...
	 , fp.diverted4_wheels_on_time_lcl
       ...
       , CONVERT_TIMEZONE(d4.time_zone_name , d4.time_zone_name,(flight_date::char(10)||' '||TO_TIME(diverted4_wheels_on_time_lcl ,'HH24MI' )) ) as diverted4_wheels_on_tmstz_lcl
	 ,CONVERT_TIMEZONE(d4.time_zone_name,'UTC' ,(flight_date::char(10)||' '||TO_TIME(diverted4_wheels_on_time_lcl ,'HH24MI' )) ) as diverted4_wheels_on_tmstz_utc
    , fp.diverted4_wheels_off_time_lcl
    , CONVERT_TIMEZONE(d4.time_zone_name , d4.time_zone_name,(flight_date::char(10)||' '||TO_TIME(diverted4_wheels_off_time_lcl ,'HH24MI' )) ) as diverted4_wheels_off_tmstz_lcl
	 ,CONVERT_TIMEZONE(d4.time_zone_name,'UTC' ,(flight_date::char(10)||' '||TO_TIME(diverted4_wheels_off_time_lcl ,'HH24MI' )) ) as diverted4_wheels_off_tmstz_utc
    ...
    , fp.diverted5_wheels_on_time_lcl
      , CONVERT_TIMEZONE(d5.time_zone_name , d5.time_zone_name,(flight_date::char(10)||' '||TO_TIME(diverted5_wheels_on_time_lcl ,'HH24MI' )) ) as diverted5_wheels_on_tmstz_lcl
	 ,CONVERT_TIMEZONE(d5.time_zone_name,'UTC' ,(flight_date::char(10)||' '||TO_TIME(diverted5_wheels_on_time_lcl ,'HH24MI' )) ) as diverted5_wheels_on_tmstz_utc
    , fp.diverted5_wheels_off_time_lcl
    , CONVERT_TIMEZONE(d5.time_zone_name , d5.time_zone_name,(flight_date::char(10)||' '||TO_TIME(diverted5_wheels_off_time_lcl ,'HH24MI' )) ) as diverted5_wheels_off_tmstz_lcl
	 ,CONVERT_TIMEZONE(d5.time_zone_name,'UTC' ,(flight_date::char(10)||' '||TO_TIME(diverted5_wheels_off_time_lcl ,'HH24MI' )) ) as diverted5_wheels_off_tmstz_utc
...
/*create index airline_flights_scheduled_ak on air_oai_facts.airline_flights_scheduled(airline_oai_code, flight_nbr, flight_date, depart_airport_oai_code);
