...
-- CREATE EXTENSION citus_columnar; --with citus 11.1
CREATE EXTENSION file_fdw;
CREATE EXTENSION PostGIS;
CREATE EXTENSION pgcrypto;
CREATE EXTENSION pgrouting;
--DROP SERVER abrams_ssd8tb;
...
--SELECT create_reference_table('air_oai_dims.aircraft_types');
--SELECT create_reference_table('air_oai_dims.world_areas');
--SELECT create_reference_table('air_oai_dims.airline_entities');
--SELECT create_reference_table('air_oai_dims.airport_history');

-- ERROR: cannot distribute relation: airline_entities
...
server mochida options 
	( format 'csv'
	, header 'true'
	, filename '/opt/_data/_air/_oai/_dims/T_AIRCRAFT_TYPES.csv'
	-- '/Volumes/ssd8tbRaid0/opt/_data/_air/_oai/_dims/T_AIRCRAFT_TYPES.csv'
...
-- '/opt/_data/_air/_oai/_dims/T_WAC_COUNTRY_STATE.csv'
...
server mochida options 
	( format 'csv'
	, header 'true'
	, filename '/opt/_data/_air/_oai/_dims/T_WAC_COUNTRY_STATE.csv'
	-- '/Volumes/ssd8tbRaid0/opt/_data/_air/_oai/_dims/T_WAC_COUNTRY_STATE.csv'
...
server mochida options 
	( format 'csv'
	, header 'true'
	, filename '/opt/_data/_air/_oai/_dims/T_CARRIER_DECODE.csv'
	-- '/Volumes/ssd8tbRaid0/opt/_data/_air/_oai/_dims/T_CARRIER_DECODE.csv'
...
-- '/opt/_data/_air/_oai/_dims/T_MASTER_CORD.csv'
-- '/Volumes/ssd8tbRaid0/opt/_data/_air/_oai/_dims/T_MASTER_CORD.csv'

-- DROP FOREIGN TABLE air_oai_dims.master_cord_fdw;
...
server mochida options 
	( format 'csv'
	, header 'true'
	, filename '/opt/_data/_air/_oai/_dims/T_MASTER_CORD.csv'
	-- '/Volumes/ssd8tbRaid0/opt/_data/_air/_oai/_dims/T_MASTER_CORD.csv'
