-- drop view if exists airlines_dbx.airline_flights_scheduled_v:
create or replace view airlines_dbx.airline_flights_scheduled_v as
...
-- drop view if exists airlines_dbx.airline_flights_completed_v:
create or replace view airlines_dbx.airline_flights_completed_v as
SELECT flight_key, flight_date
	, airline_oai_code, airline_entity_from_date, airline_entity_id, airline_entity_key
	, flight_nbr, flight_count, tail_nbr
	, depart_airport_oai_code, depart_airport_from_date, depart_airport_history_id, depart_airport_history_key
...
-- drop view if exists airlines_dbx.airline_flights_cancelled_v:
create or replace view airlines_dbx.airline_flights_cancelled_v as
SELECT flight_key, flight_date
	, airline_oai_code, airline_entity_from_date, airline_entity_id, airline_entity_key
	, flight_nbr, flight_count, tail_nbr
	, depart_airport_oai_code, depart_airport_from_date, depart_airport_history_id, depart_airport_history_key
...
-- drop view if exists airlines_dbx.airline_flights_diverted_v:
create or replace view airlines_dbx.airline_flights_diverted_v as
SELECT flight_key, flight_date
	, airline_oai_code, airline_entity_from_date, airline_entity_id, airline_entity_key
	, flight_nbr, flight_count, tail_nbr
	, depart_airport_oai_code, depart_airport_from_date, depart_airport_history_id, depart_airport_history_key
...
-- drop view if exists airlines_dbx.airline_flights_diverted_legs_v:
create or replace view airlines_dbx.airline_flights_diverted_legs_v as
...
-- drop view if exists airlines_dbx.airline_traffic_market_v:
create or replace view airlines_dbx.airline_traffic_market_v as
...
-- drop view if exists airlines_dbx.airline_traffic_segment_v:
create or replace view airlines_dbx.airline_traffic_segment_v as
...
-- drop view if exists airlines_dbx.airfare_survey_itinerary_v:
create or replace view airlines_dbx.airfare_survey_itinerary_v as
...
-- drop view if exists airlines_dbx.airfare_survey_coupon_v:
create or replace view airlines_dbx.airfare_survey_coupon_v as
...
-- drop view if exists airlines_dbx.airfare_survey_market_v:
create or replace view airlines_dbx.airfare_survey_market_v as
...
-- drop view if exists airlines_dbx.aircraft_configurations_v:
create or replace view airlines_dbx.aircraft_configurations_v as
SELECT aircraft_configuration_ref
	, aircraft_configuration_descr
FROM air_oai_dims.aircraft_configurations;

-- drop view if exists airlines_dbx.aircraft_types_v:
create or replace view airlines_dbx.aircraft_types_v as
...
-- drop view if exists airlines_dbx.airline_entities_v:
create or replace view airlines_dbx.airline_entities_v as
...
-- drop view if exists airlines_dbx.airport_history_v:
create or replace view airlines_dbx.airport_history_v as
...
-- drop view if exists airlines_dbx.aircraft_reference_v;
create or replace view airlines_dbx.aircraft_reference_v as
...
-- drop view if exists airlines_dbx.engine_reference_v;
create or replace view airlines_dbx.engine_reference_v as
